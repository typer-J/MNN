...
CXX=${CXX:-g++}
CXXFLAGS=${CXXFLAGS:-"-O3 -std=c++17 -march=rv64gcv -mabi=lp64d -static -DMNN_BUILD_STATIC_LIBS -DMNN_USE_RVV -fno-exceptions -fno-rtti"}
...
targets=(
  ...
  MNNFlashAttentionUpdateBlockOutput
  MNNUnpackConvScaleFromBuffer
  MNNConvInt8ComputeBiasFloat
  MNNConvInt8ComputeWeightKernelSum
)
